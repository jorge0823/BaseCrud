<!DOCTYPE html>
<?php include "Tabla/Programa.php";?>
<html>
<head>
                            ...
                            <div class="ibox float-e-margins">
                                <form role="form" method="GET" action="Acciones/Actualizar.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" value="<?php echo $row[$campo5]->format('Y-m-d');?>" name="<?php echo $campo5;?>" required style="border: 1px solid #fff;" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre6;?></label>
                                        <input type="date" class="form-control" value="<?php echo $row[$campo6]->format('Y-m-d');?>" name="<?php echo $campo6;?>" required style="border: 1px solid #fff;" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre7;?></label>
                                        <input type="text" class="form-control" value="<?php echo $row[$campo7];?>" name="<?php echo $campo7;?>" required style="border: 1px solid #fff;" readonly>
                                    </div>
                                    <?php
                                    } //fin del while
                                    ?>
                        ...
                        <div class="ibox-content">
                            <div class="ibox float-e-margins">
                                <form role="form" method="GET" action="Acciones/<?php echo $tabla;?>.php">
                                    ...
                                    <div class="form-group">
                                        <label><?php echo $nombre5;?></label>
                                        <input type="date" class="form-control" value="<?php echo $row[$campo5]->format('Y-m-d');?>" name="<?php echo $campo5;?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre6;?></label>
                                        <input type="date" class="form-control" value="<?php echo $row[$campo6]->format('Y-m-d');?>" name="<?php echo $campo6;?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre7;?></label>
                                        <select name="<?php echo $campo7;?>" class="form-control m-b" required>
                        ...
                        <div class="ibox-content">
                            <div class="ibox float-e-margins">
                                <form role="form" method="GET" action="Acciones/<?php echo $tabla;?>.php">
                                    ...
                                    <div class="form-group">
                                        <label><?php echo $nombre5;?></label>
                                        <input type="date" class="form-control" value="" name="<?php echo $campo5;?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre6;?></label>
                                        <input type="date" class="form-control" value="" name="<?php echo $campo6;?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo $nombre7;?></label>
                                        <select name="<?php echo $campo7;?>" class="form-control m-b" required>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row[$campo5]->format('Y-m-d'); ?></td>
                                            <td><?php echo $row[$campo6]->format('Y-m-d'); ?></td>
