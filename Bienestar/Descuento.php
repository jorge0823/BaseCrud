<!DOCTYPE html>
<?php include "Tabla/Descuento.php";?>
<html>
<head>
                            ...
                            <div class="ibox float-e-margins">
                                <form role="form" method="GET" action="Acciones/Actualizar.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $fechaFormateada;?>" name="<?php echo $campo5;?>" required style="border: 1px solid #fff;" readonly>
                                    </div>
                                    <?php
                                    } //fin del while
                                    ?>
